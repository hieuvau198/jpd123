...
export const ALL_LEVELS = [
  ...
  { min: 51, max: 80, title: 'Wolfie', img: 'https://i.postimg.cc/MHS7Gkcd/wolf-1.jpg', color: '#3c3f42' },
  { min: 81, max: 99, title: 'The Great Tiger', img: 'https://i.postimg.cc/hPMLK5KM/fat-tiger-1.png', color: '#fa8c16' },
  { min: 100, max: 100, title: 'King of The Jungle', img: 'https://i.postimg.cc/zXmzVzGV/dragon-1.jpg', color: '#37eef1' },
];
