...
import RecentPracticeRecords from '../components/RecentPracticeRecords';
...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      <Row gutter={[32, 32]}>
        {/* CỘT TRÁI: Hall of Fame & Hoạt động gần đây */}
        <Col xs={24} lg={8}>
          <HallOfFame />
            ...
            <Col xs={24} sm={12} md={8}>
              <Link to="/phonetic" style={{ textDecoration: 'none' }}>
                ...
                >
                  ...
                  <Title level={3} style={{ color: '#2febe2', margin: 0 }}>
                    Phonetic
                  </Title>
                </Card>
              </Link>
            ...
            <Col xs={24} sm={12} md={8}>
              <Link to="/speaks" style={{ textDecoration: 'none' }}>
                ...
                >
                  ...
                  <Title level={3} style={{ color: '#eb2f96', margin: 0 }}>
                    Speak
                  </Title>
                </Card>
              </Link>
            ...
            <Col xs={24} sm={12} md={8}>
              <Link to="/documents" style={{ textDecoration: 'none' }}>
                ...
                >
                  ...
                  <Title level={3} style={{ color: '#1cebfa', margin: 0 }}>
                    Documents
                  </Title>
                </Card>
              </Link>
