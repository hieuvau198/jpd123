...
const ReadingSessionHeader = ({ data, submitted, scoreResult, onBack, onSubmit, onReset }) => {
  return (
      ...
      <div className="bg-white/95 backdrop-blur-md p-6 rounded-2xl shadow-lg flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <div className="flex gap-2 mt-2 flex-wrap">
            ...
            <Tag color="orange">Nhấp vào từ để tra nghĩa</Tag>
          </div>
        </div>
        ...
        {!submitted ? (
          <Button
            ...
            size="large"
            onClick={onSubmit}
            className="bg-emerald-600 hover:bg-emerald-500 border-0 h-12 px-8 font-bold rounded-xl shadow-lg"
          >
            Nộp
          </Button>
        ) : (
