        ...
        {defenseLevels.map((level) => (
          ...
          >
            <div className="flex justify-between items-start mb-4">
              ...
              <span className={`px-3 py-1 rounded-full text-xs font-bold ${level.difficulty === 'Hard' ? 'bg-red-500 text-white' : 'bg-green-500 text-white'}`}>
                {level.difficulty}
              </span>
            </div>
            ...
            <div className="flex items-center gap-4 text-xs text-white/40 font-mono">
              ...
              <span>•</span>
              <span>Speed: {level.spawnRate/1000}s</span>
            </div>
          </div>
        ))}
      </div>
